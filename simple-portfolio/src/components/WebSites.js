...
function WebSites() {
    return (
        ...
        <div className='px-16 pt-10'>
            ...
            <h3 className='text-3xl text-left dark:text-white'>Portfolio</h3>

            <p className='text-left pt-5 dark:text-white'>
            ...
            <p className='text-left py-5 dark:text-white'>I offer from a wide range of services, including brand design,
                programming and teaching.</p>

            <div className='flex gap-10 pb-10 flex-wrap'>
